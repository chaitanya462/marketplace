...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VMSJOBSAVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VMSJOBSAVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VMSJOBSAVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VMSJOBSAVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VMSJOBSAVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VMSJOBSAVE actions', async () => {
      const expectedActions = [
        {
