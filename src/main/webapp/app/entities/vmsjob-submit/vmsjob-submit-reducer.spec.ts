...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VMSJOBSUBMIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_VMSJOBSUBMIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VMSJOBSUBMIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VMSJOBSUBMIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VMSJOBSUBMIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VMSJOBSUBMIT actions', async () => {
      const expectedActions = [
        {
