...
import { getEntities, reset } from './worker.reducer';
...
export const Worker = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const totalItems = useAppSelector(state => state.worker.totalItems);
  const links = useAppSelector(state => state.worker.links);
  const entity = useAppSelector(state => state.worker.entity);
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="simplifyMarketplaceApp.worker.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('firstName')}>
                    <Translate contentKey="simplifyMarketplaceApp.worker.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('middleName')}>
                    <Translate contentKey="simplifyMarketplaceApp.worker.middleName">Middle Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('lastName')}>
                    <Translate contentKey="simplifyMarketplaceApp.worker.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
