              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="simplifyMarketplaceApp.category.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('name')}>
                    <Translate contentKey="simplifyMarketplaceApp.category.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('isParent')}>
                    <Translate contentKey="simplifyMarketplaceApp.category.isParent">Is Parent</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
